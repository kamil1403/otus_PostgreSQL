...
Результат см. на скриншоте 🖼️ ["1.png"](https://github.com/kamil1403/otus_PostgreSQL/blob/main/1.png)

**2. Статус Barman и успешный бэкап:**
Результат см. на скриншоте 🖼️ ["2.png"](https://github.com/kamil1403/otus_PostgreSQL/blob/main/2.png)
